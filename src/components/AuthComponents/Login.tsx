import { signInWithEmail } from '@/utils/request/auth';
    ...
    <section className='w-full md:max-w-[500px] text-white p-2'>
        ...
        <form onSubmit={handleSubmit(handleSignUp)}>
            <div className='leading-5 my-3'>
                ...
                <small className='text-slate-500'>Start collaborating with your team today</small>
            </div>
            <div>
                ...
                <div className='my-3'>
                    ...
                    <input
                    {...register("email")}
                     className='bg-slate-900 p-2 border border-slate-600 rounded-md focus:outline-none w-full' type="email" placeholder='email' />
                      <div>
              {errors.email && (
                ...
                <div className='my-3'>
                    ...
                    <input  {...register("password")} className='bg-slate-900 p-2 border border-slate-600 rounded-md focus:outline-none w-full' type="password" placeholder='password' />
                    <div>
              {errors.password && (
            ...
            <div className='my-5 w-full'>
                <button disabled className='p-2 bg-brand rounded-md capitalize w-full focus:outline-none font-medium' type="submit"> {isSubmitting ? (
              <div>
                <Loader />
              </div>
            ) : (
